...
//------------------------------------------------------------------------------
extern int16 *gCoeffBuf;

// 8*8*4 bytes * 3 = 768
extern uint8_t *gMCUBufR;
extern uint8_t *gMCUBufG;
extern uint8_t *gMCUBufB;

// 256 bytes
extern int16_t *gQuant0;
extern int16_t *gQuant1;
extern uint8_t *gHuffVal2;
extern uint8_t *HuffVal3;
// 6 bytes
...
{
   uint8 status;
   memset(gHuffTab0.mMinCode,0,sizeof(gHuffTab0.mMinCode));
   memset(gHuffTab0.mMaxCode,0,sizeof(gHuffTab0.mMaxCode));
   memset(gHuffTab0.mValPtr,0,sizeof(gHuffTab0.mValPtr));
   memset(gHuffTab1.mMinCode,0,sizeof(gHuffTab1.mMinCode));
   memset(gHuffTab1.mMaxCode,0,sizeof(gHuffTab1.mMaxCode));
   memset(gHuffTab1.mValPtr,0,sizeof(gHuffTab1.mValPtr));
   memset(gHuffTab2.mMinCode,0,sizeof(gHuffTab2.mMinCode));
   memset(gHuffTab2.mMaxCode,0,sizeof(gHuffTab2.mMaxCode));
   memset(gHuffTab2.mValPtr,0,sizeof(gHuffTab2.mValPtr));
   memset(gHuffTab3.mMinCode,0,sizeof(gHuffTab3.mMinCode));
   memset(gHuffTab3.mMaxCode,0,sizeof(gHuffTab3.mMaxCode));
   memset(gHuffTab3.mValPtr,0,sizeof(gHuffTab3.mValPtr));
   memset(gLastDC,0,sizeof(gLastDC));
   memset(gHuffVal0,0,sizeof(gHuffVal0));
   memset(gHuffVal1,0,sizeof(gHuffVal1));
   memset(gCompIdent,0,sizeof(gCompIdent));
   memset(gCompHSamp,0,sizeof(gCompHSamp));
   memset(gCompVSamp,0,sizeof(gCompVSamp));
   memset(gCompQuant,0,sizeof(gCompQuant));
   memset(gCompList,0,sizeof(gCompList));
   memset(gCompDCTab,0,sizeof(gCompDCTab));
   memset(gCompACTab,0,sizeof(gCompACTab));
   ...
   //uint16 mMaxCode[16];  G.A.
   //uint8 mValPtr[16];    G.A.
